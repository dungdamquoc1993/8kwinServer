...
namespace differ {
	public class Results_differ_data_RayCollision : global::haxe.lang.HxObject {
		
		public Results_differ_data_RayCollision(global::haxe.lang.EmptyObject empty) {
		}
		
		
		public Results_differ_data_RayCollision(int size) {
			global::differ.Results_differ_data_RayCollision.__hx_ctor_differ_Results_differ_data_RayCollision(this, size);
		}
		
		
		public static void __hx_ctor_differ_Results_differ_data_RayCollision(global::differ.Results_differ_data_RayCollision __hx_this, int size) {
			__hx_this.count = 0;
			global::ArrayHaxe<object> _g = new global::ArrayHaxe<object>(new object[]{});
			{
				...
				while (( _g2 < _g1 )) {
					int i = _g2++;
					_g.push(new global::differ.data.RayCollision());
				}
		...
		public void push(global::differ.data.RayCollision @value) {
			this.items[this.count] = @value;
			this.count++;
		}
		
		
		public global::differ.data.RayCollision @get(int index) {
			unchecked {
				if (( ( index < 0 ) && ( index > ( this.count - 1 ) ) )) {
					return null;
				}
				
				return ((global::differ.data.RayCollision) (this.items[index]) );
			}
		}
		
		
		public global::differ.data.RayCollision pull() {
			if (( this.items.length == this.count )) {
				this.items.push(new global::differ.data.RayCollision());
			}
			
			return ((global::differ.data.RayCollision) (this.items[this.count]) );
		}
		
		
		public global::differ.Results_differ_data_RayCollision clear() {
			this.count = 0;
			return this;
		}
		
		
		public global::differ.ResultsIterator_differ_data_RayCollision iterator() {
			return new global::differ.ResultsIterator_differ_data_RayCollision(((global::differ.Results_differ_data_RayCollision) (this) ));
		}
		...
		public override object __hx_invokeField(string field, int hash, global::ArrayHaxe dynargs) {
			unchecked {
				switch (hash) {
					...
					case 1247875546:
					{
						this.push(((global::differ.data.RayCollision) (dynargs[0]) ));
						break;
					}
