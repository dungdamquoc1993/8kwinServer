...
public sealed class ArrayHaxe<T> : global::haxe.lang.HxObject, global::ArrayHaxe {
	
	public ArrayHaxe(global::haxe.lang.EmptyObject empty) {
	}
	
	
	public ArrayHaxe(T[] native) {
		global::ArrayHaxe<object>.__hx_ctor__Array<T>(((global::ArrayHaxe<T>) (this) ), ((T[]) (native) ));
	}
	
	
	public ArrayHaxe() {
		global::ArrayHaxe<object>.__hx_ctor__Array<T>(((global::ArrayHaxe<T>) (this) ));
	}
	
	
	public static void __hx_ctor__Array<T_c>(global::ArrayHaxe<T_c> __hx_this, T_c[] native) {
		__hx_this.length = ( native as global::System.Array ).Length;
		__hx_this.__a = native;
	}
	
	
	public static void __hx_ctor__Array<T_c>(global::ArrayHaxe<T_c> __hx_this) {
		__hx_this.length = 0;
		__hx_this.__a = new T_c[0];
	}
	
	
	public static object __hx_cast<T_c_c>(global::ArrayHaxe me) {
		return ( (( me != null )) ? (me.Array_cast<T_c_c>()) : default(object) );
	}
	
	
	public static global::ArrayHaxe<X> ofNative<X>(X[] native) {
		return new global::ArrayHaxe<X>(((X[]) (native) ));
	}
	
	
	public static global::ArrayHaxe<Y> alloc<Y>(int size) {
		return new global::ArrayHaxe<Y>(((Y[]) (new Y[size]) ));
	}
	...
	public object Array_cast<T_c>() {
		unchecked {
			...
			global::ArrayHaxe<T_c> new_me = new global::ArrayHaxe<T_c>(((global::haxe.lang.EmptyObject) (global::haxe.lang.EmptyObject.EMPTY) ));
	...
	public global::ArrayHaxe<T> concat(global::ArrayHaxe<T> a) {
		...
		return new global::ArrayHaxe<T>(((T[]) (retarr) ));
	}
	...
	public global::ArrayHaxe<T> slice(int pos, global::haxe.lang.Null<int> end) {
		if (( pos < 0 )) {
			pos = ( this.length + pos );
			if (( pos < 0 )) {
				pos = 0;
	...
	public global::ArrayHaxe<T> splice(int pos, int len) {
		if (( len < 0 )) {
			return new global::ArrayHaxe<T>();
		}
		...
		global::ArrayHaxe<T> ret1 = new global::ArrayHaxe<T>(((T[]) (ret) ));
		int end = ( pos + len );
	...
	public global::ArrayHaxe<S> map<S>(global::haxe.lang.Function f) {
		global::ArrayHaxe<S> ret = new global::ArrayHaxe<S>(new S[]{});
		{
			int _g = 0;
			global::ArrayHaxe<T> _g1 = this;
			while (( _g < _g1.length )) {
				T elt = _g1[_g];
				 ++ _g;
	...
	public global::ArrayHaxe<T> filter(global::haxe.lang.Function f) {
	...
	public global::ArrayHaxe<T> copy() {
		int len = this.length;
		T[] __a = this.__a;
		T[] newarr = new T[len];
	...
	public object iterator() {
		return new global::_Array.ArrayIterator<T>(((global::ArrayHaxe<T>) (this) ));
	}
	...
	public override object __hx_invokeField(string field, int hash, global::ArrayHaxe dynargs) {
		unchecked {
			switch (hash) {
				...
				case 1204816148:
				{
					return this.concat(((global::ArrayHaxe<T>) (global::ArrayHaxe<object>.__hx_cast<T>(((global::ArrayHaxe) (dynargs[0]) ))) ));
				}
	...
	object global::ArrayHaxe.this[int key]{
		get{
...
#pragma warning disable 109, 114, 219, 429, 168, 162
[global::haxe.lang.GenericInterface(typeof(global::ArrayHaxe<object>))]
public interface ArrayHaxe : global::haxe.lang.IHxObject, global::haxe.lang.IGenericObject {
...
namespace _Array {
	public sealed class ArrayIterator<T> : global::haxe.lang.HxObject, global::_Array.ArrayIterator {
		...
		public ArrayIterator(global::ArrayHaxe<T> a) {
			global::_Array.ArrayIterator<object>.__hx_ctor__Array_ArrayIterator<T>(((global::_Array.ArrayIterator<T>) (this) ), ((global::ArrayHaxe<T>) (a) ));
		}
		
		
		public static void __hx_ctor__Array_ArrayIterator<T_c>(global::_Array.ArrayIterator<T_c> __hx_this, global::ArrayHaxe<T_c> a) {
			__hx_this.arr = a;
		...
		public override object __hx_setField(string field, int hash, object @value, bool handleProperties) {
			unchecked {
				switch (hash) {
					...
					case 4849249:
					{
						this.arr = ((global::ArrayHaxe<T>) (global::ArrayHaxe<object>.__hx_cast<T>(((global::ArrayHaxe) (@value) ))) );
						return @value;
					}
