			...
			unchecked {
				...
				while (( i < fields.length )) {
					...
					switch (field) {
						...
						{
							if (( this.vals != null )) {
								V_c[] __temp_new_arr35 = new V_c[this.vals.Length];
								int __temp_i36 = -1;
								while ((  ++ __temp_i36 < this.vals.Length )) {
									object __temp_obj37 = ((object) (this.vals[__temp_i36]) );
									if (( __temp_obj37 != null )) {
										__temp_new_arr35[__temp_i36] = global::haxe.lang.Runtime.genericCast<V_c>(__temp_obj37);
									}
									
								}
								
								new_me.vals = __temp_new_arr35;
							}
							else {
								new_me.vals = null;
							}
						...
						{
							if (( this._keys != null )) {
								K_c[] __temp_new_arr38 = new K_c[this._keys.Length];
								int __temp_i39 = -1;
								while ((  ++ __temp_i39 < this._keys.Length )) {
									object __temp_obj40 = ((object) (this._keys[__temp_i39]) );
									if (( __temp_obj40 != null )) {
										__temp_new_arr38[__temp_i39] = global::haxe.lang.Runtime.genericCast<K_c>(__temp_obj40);
									}
									
								}
								
								new_me._keys = __temp_new_arr38;
							}
							else {
								new_me._keys = null;
							}
		...
		public virtual void @set(K key, V @value) {
			unchecked {
				...
				if (( flag1 == 0 )) {
					...
					bool x1 = global::haxe.lang.Runtime.eq(this._keys[x], key);
					this.vals[x] = @value;
				}
...
namespace haxe.ds._ObjectMap {
	public sealed class ObjectMapValueIterator<K, T> : global::haxe.lang.HxObject, global::haxe.ds._ObjectMap.ObjectMapValueIterator {
		...
		public static void __hx_ctor_haxe_ds__ObjectMap_ObjectMapValueIterator<K_c, T_c>(global::haxe.ds._ObjectMap.ObjectMapValueIterator<K_c, T_c> __hx_this, global::haxe.ds.ObjectMap<K_c, T_c> m) {
			__hx_this.i = 0;
			__hx_this.m = m;
			__hx_this.len = m.nBuckets;
		}
