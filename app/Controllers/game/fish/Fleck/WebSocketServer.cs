    ...
    public class WebSocketServer : IWebSocketServer
    {
        ...
        public WebSocketServer(string location, bool supportDualStack = true)
        {
           ...
           // {
                ...
                //{
                    //trySetSocketOption(socket, SocketOptionLevel.IPv6, SocketOptionName.IPv6Only, false);
                    //trySetSocketOption(socket, SocketOptionLevel.Socket, SocketOptionName.ReuseAddress, true);
                    //trySetSocketOption(socket, SocketOptionLevel.Socket, SocketOptionName.DontLinger, true);
                //}
           // }
        ...
        private void trySetSocketOption(Socket socket, SocketOptionLevel optionLevel, SocketOptionName optionName, bool optionValue)
        {
            try
            {
            ...
            {
                FleckLog.Error(string.Format("Fail to set socket option {0} to {1}: {2}", optionName.ToString(), optionValue, ex.Message), null);
            }
        }
