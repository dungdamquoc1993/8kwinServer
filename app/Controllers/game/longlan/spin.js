...
module.exports = function(client, data){
	if (!!data && !!data.cuoc && Array.isArray(data.line)) {
		...
		if (!(bet == 100 || bet == 1000 || bet == 10000) || line.length < 1) {
			...
			//loadCached(bet);
			client.LongLan = void 0 === client.LongLan ? {id:'', red:red, bet:bet, bonus:null, bonusX:0, bonusL:0, bonusWin:0, free:0,lastBet:bet} :client.LongLan;
			client.LongLan.red = red;
			client.LongLan.bet = bet;
			if(client.LongLan.free > 0 && bet != client.LongLan.lastBet){
				client.red({LongLan:{notice:'Bạn không nên đổi cược khi đang free spin'}});
			}else {
				client.LongLan.lastBet = bet;
					...
					HU.findOne({game:'long', type:bet, red:red}, {}, function(err2, dataHu){
						...
						.then(result => {
							...
							if (red) {
								...
								client.red({longlan:{status:1, cel:[cel1, cel2, cel3, cel4, cel5], line_win:result, win:bet_win, free:client.LongLan.free, isFree:isFree, isBonus:client.LongLan.bonusX, isNoHu:nohu, isBigWin:isBigWin}, user:{red:user.red-tongCuoc}});
								...
								client.red({longlan:{status:1, cel:[cel1, cel2, cel3, cel4, cel5], line_win:result, win:bet_win, free:client.LongLan.free, isFree:isFree, isBonus:!!client.LongLan.bonusX, isNoHu:nohu, isBigWin:isBigWin, thuong:thuong}, user:{xu:user.xu-tongCuoc}});
