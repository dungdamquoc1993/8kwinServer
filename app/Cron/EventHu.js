		...
		Promise.all(result[0].map(function(users, index){
			if (index == 0) {
				...
				UserInfo.findOneAndUpdate({'id': users.uid}, {$inc:{'red':150000}}).exec(function(err, user){
					TaiXiu_event.create({date:stringTime, top:index+1, name:user.name, line:users.top, win:true, first:users.first, last:users.last, reward:150000});
				});
				createMess(users.uid, 150000, index+1, 'Dây Thắng');
			}else if (index == 2) {
				...
				UserInfo.findOneAndUpdate({'id': users.uid}, {$inc:{'red':30000}}).exec(function(err, user){
					TaiXiu_event.create({date:stringTime, top:index+1, name:user.name, line:users.top, win:true, first:users.first, last:users.last, reward:30000});
				});
				createMess(users.uid, 30000, index+1, 'Dây Thắng');
				...
				UserInfo.findOneAndUpdate({'id': users.uid}, {$inc:{'red':10000}}).exec(function(err, user){
					TaiXiu_event.create({date:stringTime, top:index+1, name:user.name, line:users.top, win:true, first:users.first, last:users.last, reward:10000});
				});
				createMess(users.uid, 10000, index+1, 'Dây Thắng');
			}
		}));
		...
		Promise.all(result[1].map(function(usersL, indexL){
			if (indexL == 0) {
				...
				UserInfo.findOneAndUpdate({'id': usersL.uid}, {$inc:{'red':150000}}).exec(function(err, user){
					TaiXiu_event.create({date:stringTime, top:indexL+1, name:user.name, line:usersL.top, win:false, first:usersL.first, last:usersL.last, reward:150000});
				});
				createMess(usersL.uid, 150000, indexL+1, 'Dây Thua');
			}else if (indexL == 2) {
				...
				UserInfo.findOneAndUpdate({'id': usersL.uid}, {$inc:{'red':30000}}).exec(function(err, user){
					TaiXiu_event.create({date:stringTime, top:indexL+1, name:user.name, line:usersL.top, win:false, first:usersL.first, last:usersL.last, reward:30000});
				});
				createMess(usersL.uid, 30000, indexL+1, 'Dây Thua');
				...
				UserInfo.findOneAndUpdate({'id': usersL.uid}, {$inc:{'red':10000}}).exec(function(err, user){
					TaiXiu_event.create({date:stringTime, top:indexL+1, name:user.name, line:usersL.top, win:false, first:usersL.first, last:usersL.last, reward:10000});
				});
				createMess(usersL.uid, 10000, indexL+1, 'Dây Thua');
			}
		}));
